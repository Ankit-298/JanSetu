...
const INDUSTRY_PARTNERS_DATA = [
  {
    ...
    type: 'csr',
    sector: 'Multiple',
    description: 'CSR arm of Tata Steel driving community development and technical innovation in Jharkhand',
    location: { city: 'Jamshedpur', state: 'Jharkhand' },
    contact: { email: 'foundation@tatasteel.com', phone: '+91 657 222 3456', website: 'https://www.tatasteel.com' },
    capabilities: ['Funding', 'Mentorship', 'Testing Facility', 'Infrastructure', 'Raw Materials', 'Domain Expertise'],
  ...
  },
  {
    ...
    companyName: 'Jharkhand Startup Hub',
    type: 'innovation_hub',
    sector: 'Multiple',
    description: 'Government-backed startup ecosystem for Jharkhand entrepreneurs and student innovators',
    location: { city: 'Ranchi', state: 'Jharkhand' },
    contact: { email: 'hub@jharkhandstartup.in', phone: '+91 651 240 7890', website: 'https://jharkhandstartup.in' },
    capabilities: ['Funding', 'Mentorship', 'Infrastructure', 'Software/Cloud Credits'],
    fundingCapacity: 1000000,
    pastCollaborations: 8,
    stats: { totalCollaborations: 8, activeCollaborations: 4, completedProjects: 4, totalFunding: 1000000, studentsImpacted: 200 },
    isActive: true, isVerified: true
  },
  {
    name: 'Apex Engineering & Testing Labs',
    companyName: 'Apex Engineering & Testing Labs',
    type: 'industry',
    sector: 'Urban Infrastructure',
    description: 'Advanced materials testing, civil infrastructure analysis, and quality assurance center',
    location: { city: 'Ranchi', state: 'Jharkhand' },
    contact: { email: 'contact@apextesting.org', phone: '+91 651 223 9988', website: 'https://apextesting.org' },
    capabilities: ['Testing Facility', 'Equipment', 'Mentorship', 'Raw Materials', 'Domain Expertise'],
    fundingCapacity: 3500000,
    pastCollaborations: 7,
    stats: { totalCollaborations: 7, activeCollaborations: 3, completedProjects: 4, totalFunding: 3500000, studentsImpacted: 160 },
    isActive: true, isVerified: true
  },
  {
    name: 'Tech Innovators Micro-Grant',
    companyName: 'Tech Innovators Micro-Grant',
    type: 'msme',
    sector: 'Energy & Technology',
    description: 'Seed stage civic tech grant and incubation program with limited capital threshold',
    location: { city: 'Dhanbad', state: 'Jharkhand' },
    contact: { email: 'grants@techinnovators.in', phone: '+91 326 230 1122', website: 'https://techinnovators.in' },
    capabilities: ['Funding', 'Mentorship', 'Software/Cloud Credits'],
    fundingCapacity: 200000,
    pastCollaborations: 3,
    stats: { totalCollaborations: 3, activeCollaborations: 1, completedProjects: 2, totalFunding: 200000, studentsImpacted: 60 },
    isActive: true, isVerified: true
  },
  {
    name: 'CSIR - NEERI Innovation Wing',
    companyName: 'CSIR - NEERI Innovation Wing',
    type: 'research_lab',
    sector: 'Sanitation & Environment',
    description: 'Premier research institute for environmental engineering solutions, water quality and sensor testing',
    location: { city: 'Nagpur', state: 'Maharashtra' },
    contact: { email: 'neeri@csir.res.in', website: 'https://www.neeri.res.in' },
    capabilities: ['Testing Facility', 'Mentorship', 'Domain Expertise', 'Infrastructure'],
    fundingCapacity: 1500000,
    pastCollaborations: 6,
    stats: { totalCollaborations: 6, activeCollaborations: 2, completedProjects: 4, totalFunding: 1500000, studentsImpacted: 120 },
    isActive: true, isVerified: true
  },
  {
    name: 'Jharkhand Medical Supplies Corporation',
    companyName: 'Jharkhand Medical Supplies Corporation',
    type: 'government_agency',
    sector: 'Healthcare',
    description: 'Government agency managing medical supplies, healthcare instrumentation, and telemedicine testbeds',
    location: { city: 'Ranchi', state: 'Jharkhand' },
    contact: { email: 'jmsc@jharkhand.gov.in', phone: '+91 651 249 0011' },
    capabilities: ['Funding', 'Equipment', 'Testing Facility', 'Domain Expertise'],
    fundingCapacity: 2500000,
    pastCollaborations: 4,
    stats: { totalCollaborations: 4, activeCollaborations: 1, completedProjects: 3, totalFunding: 2500000, studentsImpacted: 50 },
    isActive: true, isVerified: true
  }
];
...
async function seedDatabase() {
  try {
    ...
    const industryPartners = await IndustryProfile.insertMany(INDUSTRY_PARTNERS_DATA);
    ...
    await IndustryProfile.findByIdAndUpdate(industryPartners[0]._id, { $push: { representatives: users[6]._id } });
    await IndustryProfile.findByIdAndUpdate(industryPartners[1]._id, { $push: { representatives: users[7]._id } });
